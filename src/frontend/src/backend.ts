...
export class Backend implements backendInterface {
    ...
    async addMemory(arg0: Memory): Promise<void> {
        if (this.processError) {
            try {
    ...
    async adminAddUserProfile(arg0: Principal, arg1: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminAddUserProfile(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminDeleteUserProfile(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminDeleteUserProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHome(): Promise<Home> {
        if (this.processError) {
            try {
                const result = await this.actor.getHome();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserProfiles(): Promise<Array<[Principal, UserProfile]>> {
        if (this.processError) {
            try {
    ...
    async getVideoById(arg0: string): Promise<Video> {
        if (this.processError) {
            try {
    ...
    async saveHome(arg0: Home): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveHome(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveTheme(arg0: Theme): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTheme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMemory(arg0: Memory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMemory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
