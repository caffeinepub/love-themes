  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        love: {
          rose: "oklch(var(--love-rose))",
          blush: "oklch(var(--love-blush))",
          lavender: "oklch(var(--love-lavender))",
          peach: "oklch(var(--love-peach))",
          "dusty-rose": "oklch(var(--love-dusty-rose))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        love: "0 8px 32px rgba(0,0,0,0.12), 0 2px 8px rgba(198,106,131,0.15)",
        "love-lg": "0 16px 48px rgba(0,0,0,0.15), 0 4px 16px rgba(198,106,131,0.2)",
      },
      keyframes: {
